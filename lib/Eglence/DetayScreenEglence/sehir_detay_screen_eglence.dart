...
class SehirDetayScreenEglence extends StatefulWidget {
  final String ulkeAdi;
  final String sehirAdi;

  const SehirDetayScreenEglence({
    super.key,
  ...
  @override
  State<SehirDetayScreenEglence> createState() => _SehirDetayScreenEglenceState();
}

class _SehirDetayScreenEglenceState extends State<SehirDetayScreenEglence> {
                ...
                child: Column(
                  children: [
                    ...
                    ...liste.map((item) {
                      ...
                      return MekanContainerEglence(mekan: mekanMap);
                    }),
