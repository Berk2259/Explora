...
class UlkeDetayScreenMagaza extends StatefulWidget {
  final String ulkeAdi;
  const UlkeDetayScreenMagaza({super.key, required this.ulkeAdi});

  @override
  State<UlkeDetayScreenMagaza> createState() => _UlkeDetayScreenMagazaState();
}

class _UlkeDetayScreenMagazaState extends State<UlkeDetayScreenMagaza> {
