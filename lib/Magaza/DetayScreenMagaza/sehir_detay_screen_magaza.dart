...
class SehirDetayScreenMagaza extends StatefulWidget {
  final String ulkeAdi;
  final String sehirAdi;

  const SehirDetayScreenMagaza({
    super.key,
  ...
  @override
  State<SehirDetayScreenMagaza> createState() => _SehirDetayScreenMagazaState();
}

class _SehirDetayScreenMagazaState extends State<SehirDetayScreenMagaza> {
                ...
                child: Column(
                  children: [
                    ...
                    ...liste.map((item) {
                      ...
                      return MekanContainerMagaza(mekan: mekanMap);
                    }),
