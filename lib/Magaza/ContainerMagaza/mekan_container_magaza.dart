...
import 'package:explora/Magaza/DataMagaza/data_magaza.dart';

//Her mekan için kullanılacak konteyner bileşeni
class MekanContainerMagaza extends StatelessWidget {
  final String mekanAdi;
  const MekanContainerMagaza({super.key, required this.mekanAdi});

  Future<void> _openMaps() async {
    final String? url = KonumDataMagaza.konumlar[mekanAdi]?.first;
