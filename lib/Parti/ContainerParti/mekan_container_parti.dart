...
import 'package:explora/Parti/DataParti/data_parti.dart';

//Her mekan için kullanılacak konteyner bileşeni
class MekanContainerParti extends StatelessWidget {
  final String mekanAdi;
  const MekanContainerParti({super.key, required this.mekanAdi});

  Future<void> _openMaps() async {
    final String? url = KonumDataParti.konumlar[mekanAdi]?.first;
