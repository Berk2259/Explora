...
class UlkeDetayScreenYemek extends StatefulWidget {
  final String ulkeAdi;
  const UlkeDetayScreenYemek({super.key, required this.ulkeAdi});

  @override
  State<UlkeDetayScreenYemek> createState() => _UlkeDetayScreenYemekState();
}

class _UlkeDetayScreenYemekState extends State<UlkeDetayScreenYemek> {
