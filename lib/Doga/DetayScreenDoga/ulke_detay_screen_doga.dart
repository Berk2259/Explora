...
class UlkeDetayScreenDoga extends StatefulWidget {
  final String ulkeAdi;
  const UlkeDetayScreenDoga({super.key, required this.ulkeAdi});

  @override
  State<UlkeDetayScreenDoga> createState() => _UlkeDetayScreenDogaState();
}

class _UlkeDetayScreenDogaState extends State<UlkeDetayScreenDoga> {
